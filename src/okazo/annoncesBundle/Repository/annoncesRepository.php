...
class annoncesRepository extends EntityRepository {
    ...
    public function normaliseGeo(&$longitude = -1000, &$latitude = -1000, &$distance = null) {
        ...
        if ($distance == null) {
            $distance = 1;
        }  //la circonférence de la terre est de 40075Km, en prenant 45000, on prendra toutes les distances de la terre
        //var_dump($distance);
        if ($distance < 0) {
            $distance = 45000;
        }         //0 pour ne prendre que les annonces avec la même ville
    }
