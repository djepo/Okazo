...
namespace okazo\UserBundle\Security\User\Provider;
...
class FacebookProvider implements UserProviderInterface
{
    ...
    public function findUserByFbIdOrEmail($fbId, $email)
    {
    ...
    {           
        ...
        $user=$this->findUserByFbIdOrEmail($username, $fbdata['email']);
